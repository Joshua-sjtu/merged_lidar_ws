...
: ${AMENT_CURRENT_PREFIX:="/home/fins/Desktop/merged_lidar_ws/install/livox_to_pointcloud2"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/livox_to_pointcloud2/environment/library_path.sh"
